...
import eu.metacloudservice.service.async.AsyncCloudService;
...
public class HandlePacketOutServiceConnected implements NettyAdaptor {
    ...
    public void handle(Channel channel, Packet packet) {
        if (packet instanceof PacketOutServiceConnected) {
            ...
            var cloudService = CloudAPI.getInstance().getServicePool().getService(((PacketOutServiceConnected) packet).getName());
